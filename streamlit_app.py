...
# =========================================================
# 1️⃣ SCANNER TAB — CLEAN STREAMLIT VERSION (NO JS)
# =========================================================
with tab_scanner:
    # --------- Extra CSS to mimic SiteLock style ----------
    st.markdown(
        """
        <style>
        /* Hero background */
        ...
        /* Make the Streamlit input look like a long white bar */
    ...
    if scan_clicked:
        if not url.strip():
            ...
            if not scan_result:
                ...
                # Log for session history (if you still want it)
